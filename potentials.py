...
plt.plot(np.linspace(-1.1, 1.1, 100), d_poly__d_x(np.linspace(-1.1, 1.1, 100), 25.0))
plt.plot(np.linspace(-1.1, 1.1, 100), d_poly__d_x(np.linspace(-1.1, 1.1, 100), 75.0))
plt.plot(np.linspace(-1.1, 1.1, 100), d_poly__d_x(np.linspace(-1.1, 1.1, 100), 50.0))
plt.show()